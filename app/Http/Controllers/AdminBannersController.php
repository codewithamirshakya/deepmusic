<?php namespace App\Http\Controllers;
	...
	class AdminBannersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Banner Image","name"=>"banner_image","image"=>true];
			...
			$this->form[] = ['label'=>'Banner Image','name'=>'banner_image','type'=>'upload','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
